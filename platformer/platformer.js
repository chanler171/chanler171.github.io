...
<head>
    ...
    <style>
        ...
        canvas {
            background-color: rgb(114, 4, 108);
        }
...
<body id="body">
    ...
    <script>
        ...
        function setupGame() {
            ...
            createPlatform(6, 500, 50, 50)
            createPlatform(550, 550, 100, 50)
            createPlatform(450, 600, 100, 50)
            createPlatform(400, 650, 100, 50)
            createPlatform(4,450, 100, 50)
            createPlatform(750, 350, 100, 50)
            createPlatform(850, 300, 100, 50)
            createPlatform(550, 250, 100, 50)
            ...
            //createCannon("top",2s_Chase_Ranger_of_Jolly_Dogs_Jack_Russell.jpg/82px-Brooks_Chase_Ranger_of_Jolly_Dogs_Jack_Russell.jpg", 630, 100)00,4)
            createCannon("right", 450, 2000)
            createCannon("top", 450, 2000)

            //create collectables
            //createCollectable("www.pictureOfFish.jpg",59,299)
            createCollectable("https://upload.wikimedia.org/wikipedia/en/2/24/Weekly_Sh%C5%8Dnen_Jump_No._51_%28Dec._1984%29_is_the_first_appearance_of_Goku._Cover_art_by_Akira_Toriyama.jpg", 640, 100)
            createCollectable("https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/Burrito.JPG/250px-Burrito.JPG", 630, 100)
            createCollectable("https://upload.wikimedia.org/wikipedia/en/thumb/9/90/One_Piece%2C_Volume_61_Cover_%28Japanese%29.jpg/220px-One_Piece%2C_Volume_61_Cover_%28Japanese%29.jpg", 540, 40)
            createCollectable("https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Brooks_Chase_Ranger_of_Jolly_Dogs_Jack_Russell.jpg/82px-Brooks_Chase_Ranger_of_Jolly_Dogs_Jack_Russell.jpg", 630, 100)
            createCollectable("https://upload.wikimedia.org/wikipedia/en/thumb/d/d0/Db_TCI.jpg/170px-Db_TCI.jpg", 650, 40)
            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
